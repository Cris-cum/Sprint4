...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/credit_cards.csv'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/users_ca.csv'
INTO TABLE users_ca
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED by '\r\n'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/users_uk.csv'
INTO TABLE users_uk
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
SELECT*
FROM users_usa;
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/users_usa.csv'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/transactions.csv'
...
SELECT u.id, u.name, u.surname, COUNT(t.id) as numtransacciones
FROM users u
